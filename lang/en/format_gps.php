...
/**
 * Strings for component 'format_gps', language 'de', branch 'MOODLE_20_STABLE'
 *
 * @package   format_gps
...
$string['page-course-view-gps'] = 'Any course main page in GPS Format Pro';
$string['page-course-view-gps-x'] = 'Any course page in GPS Format Pro';
$string['pluginname'] = 'GPS Format Pro';
