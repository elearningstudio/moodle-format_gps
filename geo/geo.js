...
function GEOprocess(position) {
    ...
    GEOajax(M.cfg.wwwroot+"/course/format/gps/geo.php?latlng=" + position.coords.latitude + "," + position.coords.longitude +"");
}
...
if (navigator.geolocation) {
    ...
    document.getElementById('geo').innerHTML = 'This course can not be viewed with your browser.  Please upgrade your browser.';
}
